// ─── Shared constants ─────────────────────────────────────────────────────────
// Loaded first so all other scripts can reference these globals.

// Pitch geometry (canonical canvas 800×470)
const pitch = {
  x: 40,
  y: 20,
  width: 720,
...
// Shot-status display labels (Polish)
const STATUS_LABELS = {
  'celne':                   'Celne',
...
// Player-comparison chart colours (up to 3 players)
